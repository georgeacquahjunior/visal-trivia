      ...
      <div className="w-full max-w-xl rounded-[40px] border border-slate-200 bg-white">
        <div className="relative overflow-hidden rounded-[40px] bg-white">
          <div className="relative z-10 px-8 py-14 text-center sm:px-12 sm:py-16">
            <div className="mx-auto mb-8 grid h-20 w-20 place-items-center rounded-3xl bg-[#0066B3] text-white ">
            ...
            <h1 className="text-5xl font-black tracking-tight text-slate-950 sm:text-5xl">
              ...
              <span className="text-[#0066B3]">IT</span>
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4">
              {user ? (
                <button
                  type="button"
                  className="inline-flex w-full max-w-xs items-center justify-center gap-2 rounded-full bg-[#0066B3] px-6 py-4 text-base font-semibold text-white transition hover:bg-[#0066B3]/90"
                  onClick={onDashboard}
                >
                  Go to Dashboard
                ...
                <div className="w-full max-w-xs space-y-4">
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      className="w-full rounded-3xl border border-slate-200 bg-slate-50 px-5 py-4 text-base text-slate-950 outline-none transition focus:border-[#0066B3] focus:ring-2 focus:ring-[#0066B3]/20"
                    />
                  </div>

                  <button
                    type="button"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-3xl bg-[#0066B3] px-6 py-4 text-base font-semibold text-white transition hover:bg-[#0066B3]/90"
                  ...
                  <div className="w-full">
                    {clientId ? (
                      ...
                      <button
                        type="button"
                        className="inline-flex w-full items-center justify-center gap-3 rounded-3xl border border-slate-200 bg-white px-6 py-4 text-base font-semibold text-slate-950 transition hover:bg-slate-50"
